...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<String> _data = [];
  static const String BOT_URL = "https://covid-chatbot12.herokuapp.com/"; // replace with server address
  ...
  void _getResponse(){
    if (_queryController.text.length>0){
      ...
      try{
        client.post(BOT_URL, body: {"query" : _queryController.text},).then((response){
